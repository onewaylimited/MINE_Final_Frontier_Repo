...
public class ControllerReadTest2 extends JFrame{
	
	public ArrayList<Float> dataList = new ArrayList<Float>();
	public int axisPosition = 0;  // MODIFIED
	...
	public ControllerReadTest2() {
		super("Controller Read Test. Version: " + Version.getVersion());
		ControllerEnvironment ce = ControllerEnvironment.getDefaultEnvironment();
		Controller[] ca = ce.getControllers();
		for(int i =0;i<ca.length;i++){
			if(ca[i].getType().equals(Controller.Type.GAMEPAD)){  // MODIFIED
				makeController(ca[i]);
			}
		}
	...
	public static void main(String[] args) {
		new ControllerReadTest2().setVisible(true);
	}
